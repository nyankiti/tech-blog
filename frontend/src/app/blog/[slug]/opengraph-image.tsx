...
export default async function Image({ params }: Props) {
  ...
  const fontInter = await fs.readFile(path.join(assetsDirectory, 'Inter-Bold.ttf'));
  const fontNotSansJP = await fs.readFile(path.join(assetsDirectory, 'NotoSansJP-Bold.ttf'));
